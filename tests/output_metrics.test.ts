...
describe('OutputMetrics', () => {
    ...
    it('should output metrics correctly when data is found', () => {
        const mockRows = [
            {
                ...
                metrics: JSON.stringify({
                    ...
                    ResponsiveMaintainer_Latency: 4.56789,
                    License_Latency: 5.67890,
                    DependencyPinning_Latency: 6.78901,
                    CodeReview_Latency: 7.89012,
                    NetScore_Latency: 8.90123,
                    BusFactor: 9.01234,
                    Correctness: 0.12345,
                    RampUp: 1.23456,
                    ResponsiveMaintainer: 2.34567,
                    License: 1.0,
                    DependencyPinning: 3.45678,
                    CodeReview: 4.56789,
                    NetScore: 5.67890
                })
            }
        ...
        expect(consoleSpy).toHaveBeenCalledWith(JSON.stringify({
            ...
            ResponsiveMaintainer_Latency: 4.568,
            License_Latency: 5.679,
            DependencyPinning_Latency: 6.789,
            CodeReview_Latency: 7.890,
            NetScore_Latency: 8.901,
            BusFactor: 9.012,
            Correctness: 0.123,
            RampUp: 1.235,
            ResponsiveMaintainer: 2.346,
            License: 1.000,
            DependencyPinning: 3.457,
            CodeReview: 4.568,
            NetScore: 5.679
        }));
